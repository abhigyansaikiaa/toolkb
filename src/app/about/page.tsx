...
export const metadata: Metadata = {
  title: "About ToolKB",
  description: "Learn why we built ToolKB as a private, secure, and fast platform for everyday file tasks.",
};
      ...
      <main className="flex-1 flex flex-col relative w-full pt-24 pb-28 px-margin bg-surface max-w-2xl mx-auto">
        <div className="flex flex-col gap-space-lg">
          ...
          <section className="flex flex-col gap-space-md">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
              Most online file tools work by taking your document, uploading it to a remote server, processing it, and sending it back. This requires trusting a third party with your personal data.
            </p>
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
              ToolKB works differently. Our tools process your files directly inside your browser. When you select a photo, it is loaded into the tab, processed locally, and saved directly to your hard drive. 
            </p>
            <div className="p-space-md rounded-xl bg-surface-container-low shadow-sm border border-surface-container-highest mt-2">
              <h3 className="font-headline-sm text-headline-sm text-primary mb-2">Private by Design</h3>
              <ul className="flex flex-col gap-2 font-body-sm text-body-sm text-on-surface-variant list-disc pl-4">
                ...
                <li>Your files are not stored or retained.</li>
          ...
          <section className="flex flex-col gap-space-md">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
              You don&apos;t have to take our word for it. Open your browser&apos;s Developer Tools (F12), switch to the Network tab, and run a tool. You will see that zero network requests are made to upload your file. 
            </p>
          </section>
